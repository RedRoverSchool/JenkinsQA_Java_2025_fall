...
public class TatianaKTest {
    ...
    public void testSelenium() {
        ...
        WebElement textName = driver.findElement(By.xpath("//*[@id=\"g1051-name\"]"));
        textName.sendKeys("Tatiana");

        WebElement textEmail = driver.findElement(By.xpath("//*[@id=\"g1051-email\"]"));
        textEmail.sendKeys("Tatiana@gmail.com");
