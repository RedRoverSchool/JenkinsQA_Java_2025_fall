...
public class PipelineTest extends BaseTest {
    ...
    public void testCreatePipeline() throws InterruptedException {
        ...
        Assert.assertEquals(getDriver().findElement(By.xpath("//a[@href='job/" + pipelineName + "/']")).getText(),
                pipelineName);
    }
    ...
    public void testDeletePipeline() throws InterruptedException {
        ...
        actions.moveToElement(getDriver().findElement(By.xpath("//a[@href='job/" + pipelineName + "/']"))).perform();
        getDriver().findElement(By.xpath("//a[@href='job/" + pipelineName + "/']/button")).click();
